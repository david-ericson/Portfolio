...
public class ZappityZapZapMissileProjectile : Projectile {
    ...
    public override void Fire(Vector2 dir)
    {
        if (coolDownTimer >= bullet.coolDown) {
            ...
            clone2.GetComponentInChildren<ParticleSystem>().startColor = owner.GetComponent<Character>().baseColor;
            ...
            clone3.GetComponentInChildren<ParticleSystem>().startColor = owner.GetComponent<Character>().baseColor;
            ...
            clone4.GetComponentInChildren<ParticleSystem>().startColor = owner.GetComponent<Character>().baseColor;
