...
namespace Brogue
{
    ...
    public static class Audio
    {
        ...
        public static void LoadContent(ContentManager content)
        {
            ...
            sound[23] = new audioFile(content.Load<SoundEffect>("Sound/Jump"), "Jump");
            sound[24] = new audioFile(content.Load<SoundEffect>("Sound/ClockTick"), "ClockTick");
            sound[25] = new audioFile(content.Load<SoundEffect>("Sound/SniperShot"), "SniperShot");
            sound[26] = new audioFile(content.Load<SoundEffect>("Sound/Poison"), "Poison");
            sound[27] = new audioFile(content.Load<SoundEffect>("Sound/Arcane"), "Arcane");
